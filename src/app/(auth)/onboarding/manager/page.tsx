...
export default function OnboardingManager() {
  ...
  const saveAndContinue = async (managerIncluded: boolean = hasManager) => {
    ...
    if (managerIncluded) {
      ...
      if (companyId) {
        try {
          ...
          // FIX: this was never being saved before — without it, nothing
          // (like Settings' Manager Profile tab) has a way to know which
          // executive record belongs to this user.
    ...
    setCompanyData("onboarding_dirigeant", companyId, JSON.stringify(dirigeant));
    setCompanyData("linkedin_data", companyId, JSON.stringify(linkedinData));
